...
// POST /api/radius/accounting/custom-query - Execute custom accounting query
export async function POST(request: NextRequest) {
  try {
    ...
    // Mock data for demonstration - in production, this would execute the actual SQL query
    const mockRecords = [
      {
        id: 7001,
        username: "user1",
